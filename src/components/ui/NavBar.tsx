  ...
  return (
    ...
    >
      ...
      <button
        ...
        title="Log out"
        className="flex items-center justify-center md:justify-start gap-3 px-3 py-2 rounded-xl text-sm font-semibold transition cursor-pointer"
        style={{ color: 'rgba(255,255,255,0.95)', background: 'transparent' }}
